...
INSERT INTO `tb_banners` (`idbanner`,`titulo`,`subtitulo`,`imagem`,`link`,`ativo`,`ordem`,`url_amigavel`,`destino_link`) VALUES 
 (1,'TERRAPLENAGEM2','Desde 1999 construindo com alto padrão de qualidade.','0406201312151292054731.jpg','https://www.google.com.br/','SIM',0,'terraplenagem2','_blank'),
 (2,'teste','Sempre prestando o melhor serviço','0406201312161335098749.jpg','http://www.globo.com/','SIM',0,'teste','_self'),
...
INSERT INTO `tb_clientes` (`idcliente`,`titulo`,`imagem`,`link`,`ativo`,`ordem`,`url_amigavel`) VALUES 
 (1,'Tecnisa','0306201311501234495446.jpg','','SIM',0,'tecnisa'),
 (2,'xavier','0306201311531282648546.jpg','','SIM',0,'xavier'),
 (3,'provia','0306201311541227333608.jpg','','SIM',0,'provia'),
 (4,'Metron','0306201311551355051540.gif','','SIM',0,'metron'),
...
CREATE TABLE `tb_galerias_obras` (
  ...
  `imagem` varchar(45) NOT NULL DEFAULT 'SIM',
...
INSERT INTO `tb_galerias_obras` (`idgaleriasobras`,`id_obra`,`imagem`,`ativo`,`ordem`,`url_amigavel`) VALUES 
 (1,1,'0106201307321183970272.jpg','SIM',0,''),
 (2,1,'0106201307321233756454.jpg','SIM',0,''),
 (3,1,'0106201307321386709603.jpg','SIM',0,''),
 (4,1,'0106201307321401872629.jpg','SIM',0,''),
 (5,1,'0106201307321162192809.jpg','SIM',0,'');
...
INSERT INTO `tb_locacao` (`idlocacao`,`titulo`,`descricao`,`imagem`,`id_categorialocacao`,`ativo`,`ordem`,`url_amigavel`) VALUES 
 (1,'Titulo da Locação','Descrição breve da locacao','0106201306011208092439.jpg',1,'SIM',0,'titulo-da-locacao'),
 (2,'Titulo da Locação','Descrição breve da locacao','0106201306031228537891.jpg',1,'SIM',0,'titulo-da-locacao'),
 (3,'Titulo da Locação','Descrição breve da locacao','0106201306031247633086.jpg',3,'SIM',0,'titulo-da-locacao'),
 (4,'Titulo da Locação','Descrição breve da locacao','0106201306041362450586.jpg',3,'SIM',0,'titulo-da-locacao'),
 (5,'Titulo da Locação','Descrição breve da locacao','0106201306051316806410.jpg',2,'SIM',0,'titulo-da-locacao');
...
INSERT INTO `tb_obras` (`idobra`,`titulo`,`imagem`,`descricao`,`cidade`,`estado`,`uf`,`andamento`,`latitude`,`longitude`,`ativo`,`ordem`,`url_amigavel`,`title_google`,`keywords_google`,`description_google`) VALUES 
 (1,'Titulo da Obra','0106201306451114587111.jpg','Breve descriçao da obra','Recanto das Emas','Brasília','DF',70,'-14.408749','-54.042208','SIM',0,'titulo-da-obra','Titulo da Obra','obra, obras, engenharia','Breve descriçao da obra'),
 (2,'Obra Teste','sem_imagem.jpg','Breve descricao','Recanto das Emas','Brasília','DF',78,'-15.784944','-47.89758','SIM',0,'obra-teste','','','');
...
INSERT INTO `tb_parceiros` (`idparceiro`,`titulo`,`imagem`,`descricao`,`ativo`,`ordem`,`url_amigavel`,`url`) VALUES 
 (1,'Nome do Parceiro','0106201305311136683892.jpg','Descrição breve do parceiro','SIM',0,'nome-do-parceiro',''),
 (2,'Nome do Parceiro','0106201305331374803617.jpg','Descrição breve do parceiro','SIM',0,'nome-do-parceiro','http://www.google.com.br'),
 (3,'Nome do Parceiro','0106201305331196542264.jpg','Descrição breve do parceiro','SIM',0,'nome-do-parceiro',''),
 (4,'Nome do Parceiro','0106201305341324205456.jpg','Descrição breve do parceiro','SIM',0,'nome-do-parceiro','http://www.google.com.br'),
 (5,'Nome do Parceiro','0106201305341135351881.jpg','Descrição breve do parceiro','SIM',0,'nome-do-parceiro','');
