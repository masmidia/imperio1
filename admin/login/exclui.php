            ...
            <form action="" name="form_pags" id="form_pags" method="post" enctype="multipart/form-data">
               ...
               <h4><?php Util::imprime($row[nome]) ?></h4>
                ...
                <div class="holder-btns">
                    ...
                    <input type="submit" alt="Confirmar" value="Confirmar" class="btn_form_confirma" />
                    <input type="button" alt="Voltar" value="Voltar" class="btn_form_cancela" onclick="javascript:history.go(-1)" />
                </div>
            </form>
