...
class Upload
{
	...
	private function js($tamanho_limite, $tipo_arquivos, $qtd_maxima_arquivos)
	{
		...
		switch(func_num_args())
		{
			case 9:	
				$id = $parametros[3];
				$nome_tabela= $parametros[4];
				$nome_campo= $parametros[5];
				$nome_chave_estrangeira = $parametros[6];
				$tamanho_imagem = $parametros[7];
				$tamanho_tumb = $parametros[8];
			break;
			default:
				$id = null;
				$nome_tabela= null;
				$nome_campo= null;
				$nome_chave_estrangeira= null;
			break;
    	...
    	<script type="text/javascript">
			$(function(){
				$('#swfupload-control').swfupload({
					upload_url: "<?php echo Util::caminho_projeto(); ?>/jquery/swfupload/upload-file.php<?php echo "?id=$id&nome_tabela=$nome_tabela&nome_campo=$nome_campo&nome_chave_estrangeira=$nome_chave_estrangeira&tamanho_imagem=$tamanho_imagem&tamanho_tumb=$tamanho_tumb"; ?>",
	...
	/*	HTML 	*/
	/*-------------------------------------------------------------------------------------------------------------------*/
	public function exibe_html_upload($tamanho_limite, $tipo_arquivos, $qtd_maxima_arquivos)
	{
		//	VERIFICO OS PARAMETRO PASSADO
		$parametros = func_get_args();
		switch(func_num_args())
		{
			case 9:	
				...
				$tamanho_imagem = $parametros[7];
				$tamanho_tumb = $parametros[8];
				$this->js($tamanho_limite, $tipo_arquivos, $qtd_maxima_arquivos, $id, $nome_tabela, $nome_campo, $nome_chave_estrangeira, $tamanho_imagem, $tamanho_tumb);
			break;
			default:
				$this->js($tamanho_limite, $tipo_arquivos, $qtd_maxima_arquivos);
			break;
		}
...
$obj_upload->exibe_html_upload("3000", "*.jpg; *.jpeg; *.bmp; *.png", 20);
*/
